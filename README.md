...
### 🏆 9 Major Leagues & Competitions

Premier League • La Liga • Serie A • Bundesliga • Ligue 1 • MLS • UCL • UEL • FIFA World Cup
...
│   ├── main.py                   # API routes for predictions
...
│   ├── scrape_all_leagues.py    # Data collection from FBRef
│   ├── train_league_models.py   # Model training with weighting
│   ├── analyze_model.py         # Generate visualizations
│   ├── predict_and_analyze.py   # CLI prediction tool
│   └── cleanup_unused_visualizations.sh  # Remove unused PNGs
...
│       ├── TeamSelector.tsx      # League/team form inputs
...
| ------------------ | ---------- | ----------------- | ------------- |
| **Premier League** | England 🏴󠁧󠁢󠁥󠁮󠁧󠁿 | 1888-2024         | 51,648        |
| **La Liga**        | Spain 🇪🇸   | 1928-2024         | 30,284        |
| **Bundesliga**     | Germany 🇩🇪 | 1963-2024         | 18,972        |
| **Serie A**        | Italy 🇮🇹   | 1929-2024         | 29,516        |
